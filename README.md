...
efficiency, mean shortest path length, number of cliques, modularity/community, transitivity, assortativity, mean clustering coefficient, rich club coefficient \
